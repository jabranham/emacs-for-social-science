...
* Usage
  ...
  =C-c C-r= will let you browse your bibliography from any window. You may also insert citations in latex and markdown using =C-c C-r=. This is due to =helm-bibtex=, which we set up in the [[file:init-emacs.org]] file. 
...
* Other starter kits
  ...
  I'm by no means the first person to write a starter kit. There are several others out there, all of which are awesome. Perhaps of most direct relevance here is:
